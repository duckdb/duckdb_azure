...
# This extension uses a VCPKG build
TOOLCHAIN_FLAGS=-DVCPKG_MANIFEST_DIR='${PROJ_DIR}' -DCMAKE_TOOLCHAIN_FILE='/Users/sam/development/vcpkg/scripts/buildsystems/vcpkg.cmake'

BUILD_FLAGS=-DEXTENSION_STATIC_BUILD=1 -DBUILD_TPCH_EXTENSION=1 -DBUILD_PARQUET_EXTENSION=1 ${OSX_BUILD_UNIVERSAL_FLAG} ${STATIC_LIBCPP} ${TOOLCHAIN_FLAGS}

CLIENT_FLAGS :=

# These flags will make DuckDB build the extension
EXTENSION_FLAGS=-DDUCKDB_OOT_EXTENSION_NAMES="azure" -DDUCKDB_OOT_EXTENSION_AZURE_PATH="$(PROJ_DIR)" -DDUCKDB_OOT_EXTENSION_AZURE_SHOULD_LINK="TRUE" -DDUCKDB_OOT_EXTENSION_AZURE_INCLUDE_PATH="$(PROJ_DIR)src/include"
