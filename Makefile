...
-DDUCKDB_EXTENSION_AZURE_PATH="$(PROJ_DIR)" \
-DDUCKDB_EXTENSION_AZURE_SHOULD_LINK=1 \
-DDUCKDB_EXTENSION_AZURE_LOAD_TESTS=1 \
-DDUCKDB_EXTENSION_AZURE_TEST_PATH="$(PROJ_DIR)test" \
-DDUCKDB_EXTENSION_AZURE_INCLUDE_PATH="$(PROJ_DIR)src/include"
